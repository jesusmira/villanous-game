...
export const villainCardDefs = [
  ...
  { id: 'jhon_v_intimidacion', name: 'Intimidación', type: CardType.EFFECT, deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 2, effectIds: [] as string[], description: 'Lleva a cabo una acción Vencer sin descartar los Aliados utilizados.',                   imageFile: 'villano/intimidacion' },
  // Objects
