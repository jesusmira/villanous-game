...
export const fateCardDefs = [
  { id: CardDefId.JHON_REY_RICARDO, name: 'Rey Ricardo',   type: CardType.HERO,   deck: CardDeck.FATE, villainId: 'jhon' as const, cost: 0, strength: 5, effectIds: ['jhon_rey_ricardo_block_effect'] as string[], description: 'El Príncipe Juan no puede jugar Efectos.',                                              imageFile: 'heroe/rey' },
  ...
  { id: 'jhon_f_disfraz_1', name: 'Buen Disfraz', type: CardType.ITEM,   deck: CardDeck.FATE, villainId: 'jhon' as const, cost: 0, effectIds: ['jhon_disfraz_attach'] as string[], description: 'Únelo a un Héroe. No puede ser derrotado. PJ puede pagar 2 Monedas para descartarlo.',             imageFile: 'heroe/disfraz' },
  { id: 'jhon_f_disfraz_2', name: 'Buen Disfraz', type: CardType.ITEM,   deck: CardDeck.FATE, villainId: 'jhon' as const, cost: 0, effectIds: ['jhon_disfraz_attach'] as string[], description: 'Únelo a un Héroe. No puede ser derrotado. PJ puede pagar 2 Monedas para descartarlo.',             imageFile: 'heroe/disfraz' },
  { id: 'jhon_f_disfraz_3', name: 'Buen Disfraz', type: CardType.ITEM,   deck: CardDeck.FATE, villainId: 'jhon' as const, cost: 0, effectIds: ['jhon_disfraz_attach'] as string[], description: 'Únelo a un Héroe. No puede ser derrotado. PJ puede pagar 2 Monedas para descartarlo.',             imageFile: 'heroe/disfraz' },
...
export const villainCardDefs = [
  // Conditions
  { id: 'jhon_v_avaricia_1', name: 'Avaricia',   type: CardType.CONDITION, deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 0, effectIds: [EffectId.JHON_AVARICIA] as string[], description: 'Si otro jugador tiene 6+ Monedas, recibe 3 Monedas de Poder.',                             imageFile: 'villano/avaricia' },
  { id: 'jhon_v_avaricia_2', name: 'Avaricia',   type: CardType.CONDITION, deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 0, effectIds: [EffectId.JHON_AVARICIA] as string[], description: 'Si otro jugador tiene 6+ Monedas, recibe 3 Monedas de Poder.',                             imageFile: 'villano/avaricia' },
  // Effects
  { id: 'jhon_v_trampa_1',   name: 'Trampa',     type: CardType.EFFECT,    deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 1, effectIds: [EffectId.JHON_TRAMPA] as string[], description: 'Mueve un Aliado a cualquier ubicación. Lleva a cabo una acción Vencer.',                  imageFile: 'villano/trampa' },
  { id: 'jhon_v_trampa_2',   name: 'Trampa',     type: CardType.EFFECT,    deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 1, effectIds: [EffectId.JHON_TRAMPA] as string[], description: 'Mueve un Aliado a cualquier ubicación. Lleva a cabo una acción Vencer.',                  imageFile: 'villano/trampa' },
  ...
  // Objects
  { id: CardDefId.JHON_CORONA, name: 'Corona del Rey Ricardo', type: CardType.ITEM, deck: CardDeck.VILLAIN, villainId: 'jhon' as const, cost: 1, effectIds: [EffectId.JHON_CORONA_COST] as string[], description: 'Los costes se reducen en -1 si el Príncipe Juan está aquí.', imageFile: 'villano/corona' },
