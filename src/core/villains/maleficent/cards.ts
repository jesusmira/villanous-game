...
export const fateCardDefs: CardDef[] = [
  ...
  { id: 'mal_f_estefano',  name: 'Rey Estéfano',    type: CardType.HERO,   deck: CardDeck.FATE, villainId: 'maleficent', cost: 0, strength: 5, effectIds: ['mal_estefano_move_pawn', 'mal_sueno_victim'],   description: 'Al jugarlo, puedes mover a Maléfica a cualquier ubicación.', imageFile: 'estefano' },
