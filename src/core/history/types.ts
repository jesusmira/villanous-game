...
export const ActionKind = {
  ...
  DISCARD: 'DISCARD',
  PAY_TO_DISCARD_ITEM: 'PAY_TO_DISCARD_ITEM',
  ...
  RESOLVE_WICKET_PICK: 'RESOLVE_WICKET_PICK',
  RESOLVE_SHRINK_PICK: 'RESOLVE_SHRINK_PICK',
  RESOLVE_ENLARGE_TARGET: 'RESOLVE_ENLARGE_TARGET',
  RESOLVE_SHRINK_SLOT_CHOICE: 'RESOLVE_SHRINK_SLOT_CHOICE',
  RESOLVE_SHOT_REVEAL: 'RESOLVE_SHOT_REVEAL',
